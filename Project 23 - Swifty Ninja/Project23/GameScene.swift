...
class GameScene: SKScene {
    ...
    // 1. magic numbers
    let minScreenPositionX = 64
    let maxScreenPositionX = 960
    let bottomOffPositionY = -128
    ...
    func createEnemy(forceBomb: forceBomb = .random) {
        ...
        let randomPosition = CGPoint(x: Int.random(in: minScreenPositionX...maxScreenPositionX), y: bottomOffPositionY)
